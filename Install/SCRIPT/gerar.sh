...
msg -bar
echo -e "\033[1;37msudo apt update -y; apt upgrade -y; wget https://www.dropbox.com/s/fz5if3yofhpsplh/instalscript.sh &> /dev/null; chmod 777 instalscript.sh* && ./instalscript.sh*"
msg -bar
read -p "Enter para Finalizar"
}
