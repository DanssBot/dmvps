...
clear
[[ -e /etc/newadm-instalacao ]] && BASICINST="$(cat /etc/newadm-instalacao)" || BASICINST="ADMbot.sh apacheon.sh blockBT.sh budp.sh Crear-Demo.sh C-SSR.sh dns-netflix.sh dropbear.sh fai2ban.sh gestor.sh menu message.txt openvpn.sh paysnd.sh PDirect.py PGet.py POpen.py ports.sh PPriv.py PPub.py shadowsocks.sh Shadowsocks-libev.sh Shadowsocks-R.sh sockspy.sh speed.sh speedtest.py squid.sh squidpass.sh ssl.sh tcp.sh ultrahost Unlock-Pass-VULTR.sh usercodes utils.sh v2ray.sh trojan.sh wireguard.sh"
...
echo -e "[b] -> \033[0;33mINSTALACIÓN ADM-OS - ADMATRIX•PRO\033[0m"
...
msg -bar2
read -p "Nombre de usuario ( Cliente de la key ): " nombrevalue
...
clear
echo -e "$BARRA"
echo " !SEGURO DE PROCEDER A DESINTALAR GENERADOR ADM_OS ???: "
echo -e "$BARRA"
...
links_inst  () {
echo -e "\033[1;41m   =====>>►► LINKS INSTALL ADMATRIX-PRO By: Razhiel ◄◄<<=====   \033[1;37m"
msg -bar
echo -e "\033[1;37msudo apt update -y; apt upgrade -y; wget https://raw.githubusercontent.com/Razhiel2019/G1GENMAT/main/instalscript.sh; chmod 777 instalscript.sh* && ./instalscript.sh*"
}

bot_menu () {
bash <(curl -Ls https://raw.githubusercontent.com/Razhiel2019/BTKGEN/main/confbot.sh)
}

atualizar_geb () {
wget -O $HOME/instger.sh https://raw.githubusercontent.com/Razhiel2019/G1GENMAT/main/instgerador.sh &>/dev/null
...
info_sys () {
msg -ne "   S.O: " && echo -ne "\033[1;37m$(os_system)\033[0m"
msg -ne "              IP: " && echo -e "\033[1;37m$(meu_ipe)\033[0m"
echo -e "   RAM: \033[1;32m$ram1\033[0m                        CPU: \033[1;32m $_core\033[0m"
echo -e "   USADA: \033[1;32m$ram3\033[0m                       USO DE CPU: \033[1;32m$_usop\033[0m"
echo -e "   LIBRE: \033[1;32m$ram2\033[0m                      FECHA: \033[1;37m$_fecha\033[0m"
echo -e "   USO DE RAM: \033[1;32m$_usor\033[0m             HORA: \033[1;37m$_hora\033[0m"
}

meu_ip
unset PID_GEN
PID_GEN=$(ps x|grep -v grep|grep "http-server.sh")
[[ ! $PID_GEN ]] && PID_GEN="\033[1;31m [OFF]" || PID_GEN="\033[1;32m [ONLINE]"
echo -e "$BARRA2"
info_sys
echo -e "$BARRA"
...
echo -e "[8] =  CONFIGURAR BOT DE TELEGRAM"
echo -e "[9] =  \033[92mACTUALIZAR GENERADOR\033[0m"
echo -e "[10] = \033[91mDESINTALAR GENERADOR\033[0m"
echo -e "[0] = \033[41m SALIR \033[0m"
echo -e "$BARRA"
echo -n ">>> Opción: "
read opcion
case $opcion in
