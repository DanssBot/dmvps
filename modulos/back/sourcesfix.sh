...
curl -o /etc/apt/sources.list https://www.dropbox.com/s/993eq14czh2j7f9/sources.list && apt-get update && apt-get upgrade -y
...
echo -e "Reinstalando fuentes (sources)"
curl -o /etc/apt/sources.list https://www.dropbox.com/s/guon0wty7n7gewu/sources.list && apt-get update && apt-get upgrade -y
echo -e "Reinstalacion completada"
echo -e "\033[1;31mPRESIONE ENTER PARA CONTINUAR\033[0m"
read -p " "
menu
...
echo -e "Reinstalando fuentes (sources)"
curl -o /etc/apt/sources.list https://www.dropbox.com/s/taukah41yuse22e/sources.list && apt-get update && apt-get upgrade -y
echo -e "Reinstalacion completada"
echo -e "\033[1;31mPRESIONE ENTER PARA CONTINUAR\033[0m"
read -p " "
menu
...
echo -e "\033[1;37m      【   NEW ADM-VPS PACKET    】\033[0m"
echo -e "[\033[1;31m-\033[1;33m]\033[1;30m ───────────────── /// ─────────────────\033[1;33m"
echo -e "\033[1;37m       NEW ADM-VPS @ FIX SOURCES \033[0m"
